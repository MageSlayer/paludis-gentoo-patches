...
namespace
{
    ...
    std::shared_ptr<const EAPIEbuildMetadataVariables> make_ebuild_metadata_variables(const KeyValueConfigFile & k)
    {
        return std::make_shared<EAPIEbuildMetadataVariables>(make_named_values<EAPIEbuildMetadataVariables>(
            ...
            n::run_depend_target() = make_metadata_variable(k, "run_depend_target"),
            n::run_depend_host() = make_metadata_variable(k, "run_depend_host"),
    ...
    std::shared_ptr<const EAPIToolsOptions> make_tool_options(const KeyValueConfigFile & k)
    {
        return std::make_shared<EAPIToolsOptions>(make_named_values<EAPIToolsOptions>(
                        ...
                        n::insopts_influences_doconfd() = destringify_key<bool>(k, "insopts_influences_doconfd"),
                        n::insopts_influences_doenvd() = destringify_key<bool>(k, "insopts_influences_doenvd"),
                        n::insopts_influences_doheader() = destringify_key<bool>(k, "insopts_influences_doheader"),
