...
namespace paludis
{
    namespace n
    {
        ...
        typedef Name<struct name_shell_options_disabled> shell_options_disabled;
        ...
        typedef Name<struct name_support_portdir> support_portdir;
    ...
    namespace erepository
    {
        ...
        struct EAPIEbuildOptions
        {
            ...
            NamedValue<n::shell_options_disabled, std::string> shell_options_disabled;
            ...
            NamedValue<n::support_portdir, bool> support_portdir;
