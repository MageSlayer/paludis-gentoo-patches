...
EBUILD_METADATA_VARIABLES="DEPEND BDEPEND RDEPEND IDEPEND PDEPEND IUSE IUSE_EFFECTIVE SRC_URI \
    DOWNLOADS RESTRICT LICENSE LICENCES KEYWORDS INHERITED PROVIDE HOMEPAGE DESCRIPTION
    DEPENDENCIES E_IUSE E_DEPEND E_BDEPEND E_RDEPEND E_IDEPEND E_PDEPEND PLATFORMS DEFINED_PHASES \
    EBUILD_PHASE_FUNC MYOPTIONS E_MYOPTIONS E_DEPENDENCIES BINARY_KEYWORDS BINARY_URI \
