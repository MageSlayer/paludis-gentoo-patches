...
#ifndef PALUDIS_GUARD_SRC_CLIENTS_CAVE_CMD_PRINT_CHECKSUM_HH
#define PALUDIS_GUARD_SRC_CLIENTS_CAVE_CMD_PRINT_CHECKSUM_HH 1
...
namespace paludis
{
    namespace cave
    {
        class PALUDIS_VISIBLE PrintChecksumCommand :
            public Command
        {
            public:
