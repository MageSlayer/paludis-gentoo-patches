...
#ifndef PALUDIS_GUARD_SRC_CLIENTS_CAVE_CMD_PRINT_RESOLUTION_REQUIRED_CONFIRMATIONS_HH
#define PALUDIS_GUARD_SRC_CLIENTS_CAVE_CMD_PRINT_RESOLUTION_REQUIRED_CONFIRMATIONS_HH 1
...
namespace paludis
{
    namespace cave
    {
        class PALUDIS_VISIBLE PrintResolutionRequiredConfirmationsCommand :
            public Command
        {
            public:
