...
#ifndef PALUDIS_GUARD_SRC_CLIENTS_CAVE_CMD_PRINT_SETS_HH
#define PALUDIS_GUARD_SRC_CLIENTS_CAVE_CMD_PRINT_SETS_HH 1
...
namespace paludis
{
    namespace cave
    {
        class PALUDIS_VISIBLE PrintSetsCommand :
            public Command
        {
            public:
